...
<html lang="en">
<head>
    <title>Code coverage report for src/highlight.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> highlight.js
    </h1>
    <div class='clearfix'>
...
function flattenCodeTree(tree, className = [], newTree = []) {
  for (let i = 0; i &lt; tree.length; i++) {
    ...
    else <span class="missing-if-branch" title="else path not taken" >E</span>if (node.children) {
...
function wrapLinesInSpan(codeTree, lineStyle) {
  ...
  if (lastLineBreakIndex !== tree.length - 1) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (children &amp;&amp; children.length) {
...
export default function (lowlight, defaultStyle) {
 return function SyntaxHighlighter({
  ...
  PreTag='pre',
  CodeTag='code',
  code = Array.isArray(children) ? <span class="branch-0 cbranch-no" title="branch not covered" >children[0] </span>: children,
  ...rest
 }) {
    /* 
    ...
    */
    wrapLines = renderer &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >wrapLines === undefined </span>? <span class="branch-0 cbranch-no" title="branch not covered" >true </span>: wrapLines;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Oct 16 2017 17:43:13 GMT-0400 (EDT)
</div>
</div>
