...
<html lang="en">
<head>
    <title>Code coverage report for src/create-element.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> create-element.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
export function createStyleObject(classNames, elementStyle = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span> stylesheet) {
...
export default function createElement({ node, stylesheet, style = {}, useInlineStyles, key }) {
  ...
  if (type === 'text') {
    return value;
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (TagName) {
